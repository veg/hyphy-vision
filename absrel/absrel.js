...
datamonkey.absrel = function(analysis_data, container_id) {
  ...
  function render_bs_rel (json) {
      ...
      tree.get_nodes().forEach (function (d) {
          if (d.parent) {
              ...
              by_rate_class_count[rc][2] += tree.branch_length()(d);
      ...
      by_rate_class_count_array = by_rate_class_count_array.sort (function (a,b) {return a[0]-b[0];});
      ...
      by_rate_class_count_array = by_rate_class_count_array.selectAll ("td").data (function (d) {return d;});
      by_rate_class_count_array.enter().append ("td");
      by_rate_class_count_array.html (function (d) {return d;});    
