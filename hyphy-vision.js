  ...
  render: function() {
    ...
    return (
          React.createElement("dl", {className: "dl-horizontal"}, 
            ...
            React.createElement("dt", null, "FADE analysis settings"), React.createElement("dd", null, this.props.model), React.createElement("dd", null, this.props.grid_desc), 
          ...
          React.createElement("div", {className: "panel panel-default", id:  this.props.omegas.key}, 
              React.createElement("div", {className: "panel-heading"}, 
                  ...
                  React.createElement("p", null, 
                      React.createElement("small", null, "Test branches are shown in ", React.createElement("span", {className: "hyphy-blue"}, "blue"), " and reference branches are shown in ", React.createElement("span", {class: "hyphy-red"}, "red"))
                  ), 
              ...
              React.createElement("div", {className: "cold-md-12"}, 
                  React.createElement("div", {className: "input-group input-group-sm"}, 
                      React.createElement("div", {className: "input-group-btn"}, 
                          React.createElement("button", {id: "export-phylo-png", type: "button", className: "btn btn-default btn-sm", "data-direction": "vertical", "data-amount": "1", title: "Expand vertical spacing"}, 
                      ...
                      React.createElement("span", {className: "input-group-addon"}, 
                                  ...
                                  React.createElement("input", {type: "checkbox", id: "datamonkey-relax-tree-branch-lengths", checked: true, className: "datamonkey-relax-tree-trigger"})
                                ), 
                      React.createElement("span", {className: "input-group-addon"}, 
                                  "Show fill legend", 
                                  React.createElement("input", {type: "checkbox", id: "datamonkey-relax-tree-fill-legend", checked: true, className: "datamonkey-relax-tree-trigger"})
                                ), 
                      React.createElement("span", {className: "input-group-addon"}, 
                                  "Use color", 
                                  React.createElement("input", {type: "checkbox", id: "datamonkey-relax-tree-fill-color", checked: true, className: "datamonkey-relax-tree-trigger"})
                                )
                  )
              )
          ), 
