      ...
      <BrowserRouter>
        <div>
          ...
          <Route
            ...
            component={() =>
              <BSREL
                url={base_url + "/methods/absrel/data/ABSREL.json"}
                hyphy_vision
              />}
          />
          <Route
            ...
            component={() =>
              <BUSTED
                url={base_url + "/methods/busted/data/BUSTED.json"}
                hyphy_vision
              />}
          />
          <Route
            ...
            component={() =>
              <RELAX
                url={base_url + "/methods/relax/data/RELAX.json"}
                hyphy_vision
              />}
          />
          <Route
            ...
            component={() =>
              <FEL
                url={base_url + "/methods/fel/data/FEL.json"}
                hyphy_vision
              />}
          />
          <Route
            ...
            component={() =>
              <MEME
                url={base_url + "/methods/meme/data/MEME.json"}
                hyphy_vision
              />}
          />
          <Route
            ...
            component={() =>
              <SLAC
                url={base_url + "/methods/slac/data/SLAC.json"}
                hyphy_vision
              />}
          />
          <Route
            ...
            component={() =>
              <FUBAR
                url={base_url + "/methods/fubar/data/FUBAR.json"}
                hyphy_vision
              />}
          />
          <Route
            ...
            component={() =>
              <GARD
                url={base_url + "/methods/gard/data/GARD.json"}
                hyphy_vision
              />}
          />
        </div>
