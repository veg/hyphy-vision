...
var OmegaPlot = React.createClass({
  ...
  render: function() {
    ...
    var svg_id = this.props.omegas.key + "-svg";
          ...
          <div className="panel panel-default" id={ this.props.omegas.key }>
              <div className="panel-heading">
                  ...
                  <div className="btn-group">
                      <button id="export-{ this.props.omegas.key }-svg" type="button" className="btn btn-default btn-sm">
                          <span className="glyphicon glyphicon-floppy-save"></span> SVG
                      </button>
                      <button id="export-{ this.props.omegas.key }-png" type="button" className="btn btn-default btn-sm">
