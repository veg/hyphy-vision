        ...
        <div className="row" style={{ marginBottom: "20px" }}>
          <div className="col-md-12">
            <Header
              ...
              popover="No information to display."
            />
        ...
        var distributions = val["Rate Distributions"],
          ...
          test_row = (
            ...
            >
              ...
              <td>Test</td>
              <td>
                {distributions["Test"]["0"].omega.toFixed(2)} ({(100 * distributions["Test"]["0"].proportion).toFixed(2)}%)
              </td>
              <td>
                {distributions["Test"]["1"].omega.toFixed(2)} ({(100 * distributions["Test"]["1"].proportion).toFixed(2)}%)
              </td>
              <td>
                {distributions["Test"]["2"].omega.toFixed(2)} ({(100 * distributions["Test"]["2"].proportion).toFixed(2)}%)
              </td>
              <td>
        ...
        if (distributions["Background"]) {
          ...
          var background_row = (
            ...
            >
              ...
              <td>Background</td>
              <td>
                {distributions["Background"]["0"].omega.toFixed(2)} ({(100 * distributions["Background"]["0"].proportion).toFixed(2)}%)
              </td>
              <td>
                {distributions["Background"]["1"].omega.toFixed(2)} ({(100 * distributions["Background"]["1"].proportion).toFixed(2)}%)
              </td>
              <td>
                {distributions["Background"]["2"].omega.toFixed(2)} ({(100 * distributions["Background"]["2"].proportion).toFixed(2)}%)
              </td>
              <td>
                <i className="fa fa-bar-chart" aria-hidden="true" />
              </td>
