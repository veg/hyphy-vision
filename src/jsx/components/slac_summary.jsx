          ...
          <div className="row">
            <div className="col-md-8" id="slac-summary">
              ...
              <div className="main-result">
                <p>
                  Evidence<sup>&dagger;</sup> of pervasive <span className='hyphy-highlight'>diversifying</span>/<span className='hyphy-highlight'>purifying</span> selection was found at
                  <strong className='hyphy-highlight'> {this.state.sites.positive}</strong> / <strong className = 'hyphy-navy'>{this.state.sites.negative}</strong> sites
