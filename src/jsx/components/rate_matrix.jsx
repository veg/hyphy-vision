...
class RateMatrix extends React.Component {
  componentDidUpdate(prevProps) {
    ...
    var xAxis = d3.svg.axis().scale(characterScale).orient("top");

    var yAxis = d3.svg.axis().scale(characterScale).orient("left");

    var colorBarAxis = d3.svg.axis().scale(colorbar_axis_scale).orient("right");
    ...
    matrix.append("g").attr("class", "axis").call(xAxis);

    matrix.append("g").attr("class", "axis").call(yAxis);
  }
  render() {
    return (
