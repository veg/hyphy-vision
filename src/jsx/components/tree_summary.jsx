    ...
    return (
      <div>
        <h4 className="dm-table-header">
          Tree
          <span className="glyphicon glyphicon-info-sign" style={{"verticalAlign": "middle", "float":"right"}} aria-hidden="true" data-toggle="popover" data-trigger="hover" title="Tree summary" data-html="true" data-content="Hover over a branch to see its inferred rates and significance for selection.<br /> Hover over a column header for a description of its content." data-placement="bottom"></span>
        </h4>
